...
![Executive Overview](https://github.com/Aji-bit/Wine-Tasting/blob/main/Executive%20Overview.png)
...
The project demonstrates how **data cleaning, DAX, visualization, and storytelling** can be combined to turn raw data into actionable insig
